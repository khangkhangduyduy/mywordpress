	...
	<tr>
		...
		<td>
			...
			<ul class="backuply-nag-list">
				...
				<li>Backup support to 7 remote locations like FTPS, SFTP, WebDav, Google Drive, OneDrive, Dropbox, Amazon S3 and more to come...</li>
			...
			<ul class="backuply-loc-types">
				...
				<li><img src="'. BACKUPLY_URL . '/assets/images/gdrive.svg" height="40" width="40" alt="Google Drive Logo" title="Google Drive"/></li>
